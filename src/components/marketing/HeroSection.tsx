  ...
  return (
    <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          <h1 className="max-w-3xl text-5xl font-black tracking-tight text-text-primary sm:text-6xl">
        ...
        <GlassCard className="relative">
          ...
          <div className="space-y-3">
            {["Demand calculated", "Growers allocated", "QC queue clean"].map((item, index) => (
              <div key={item} className="flex items-center justify-between rounded-xl bg-white/60 p-4">
